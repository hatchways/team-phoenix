                    ...
                    <Box ml={2}>
                        <Box mt={1} mb={1}>
                            <ListItem>
                                ...
                                <ListItemSecondaryAction><Button className={classes.forEditButton}>Edit</Button></ListItemSecondaryAction>
                            </ListItem>
                        </Box>
                        <Divider/>
                        <Box mt={1} mb={1}>
                            <ListItem>
                                <ListItemText>2. We will add event to "<span className={classes.bold}>{props.email}</span>"</ListItemText>
                                <ListItemSecondaryAction><Button className={classes.forEditButton}>Edit</Button></ListItemSecondaryAction>
                            </ListItem>
                        </Box>
                        <Divider/>
